...
export default function AdminQRPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1f2e] flex flex-col items-center justify-center px-4 sm:px-6 py-6 sm:py-8">
      <div className="w-full max-w-2xl">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 relative">
          <button
            ...
            className="bg-[#10b981] hover:bg-[#059669] text-white py-3.5 sm:py-4 px-4 sm:px-6 rounded-[16px] text-sm sm:text-base font-semibold transition-colors flex items-center justify-center gap-2"
          >
          ...
          <div className="relative">
            <button
              ...
              className="w-full bg-[#3b82f6] hover:bg-[#2563eb] text-white py-3.5 sm:py-4 px-4 sm:px-6 rounded-[16px] text-sm sm:text-base font-semibold transition-colors flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
