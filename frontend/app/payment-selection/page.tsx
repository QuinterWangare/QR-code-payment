...
export default function PaymentSelectionPage() {
  ...
  return (
    ...
    >
      ...
      {showQrBadge && (
        <div className={`w-full flex justify-center mb-4 transition-all duration-700 ${qrBadgeFading ? "opacity-0 -translate-y-1" : "opacity-100 translate-y-0"}`}>
          <div className="inline-flex items-center gap-2 bg-[#10b981] text-white px-5 py-3 rounded-full shadow-lg text-sm font-medium">
